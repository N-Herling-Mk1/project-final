...
-   <code>geoid</code>: The U.S. Census Bureau ACS county id.

-   <code>name</code>: The U.S. Census Bureau ACS county name.

-   <code>year</code>: The year of U.S. Census Bureau ACS sample.

-   <code>geometry</code>: The county geographic boundaries.

-   <code>total_pop</code>: The total population.

-   <code>plumbing</code>: The total owner occupied households lacking plumbing facilities.

-   <code>percent_lacking_plumbing</code>: The percent of population lacking plumbing facilities.

    ## water_insecurity_2022_data

<details>
  <summary>Code: Water Insecurity 2022 data</summary>
```{r, echo=TRUE, results='hide'}
# Load required packages

# Create summary table
table1 <- tibble(
  variable = c("geoid", "name", "geometry",
               "year", "total_pop", "plumbing",
...
gt_table <- table1 |>
  gt() |>
  tab_header(
    title = "Table 1: Variable Summary for Plumbing Dataset"
  ) |>
  fmt(
